...
struct DebugForceJoinProbabilisticFilterSetting {
	using RETURN_TYPE = bool;
	static constexpr const char *Name = "debug_force_join_probabilistic_filter";
	static constexpr const char *Description =
	    "DEBUG SETTING: force probabilistic join filter pushdown when structurally possible";
	static constexpr const char *InputType = "BOOLEAN";
	static constexpr const char *DefaultValue = "false";
	static constexpr SettingScopeTarget Scope = SettingScopeTarget::LOCAL_DEFAULT;
...
struct PrefixRangeFilterSetting {
	using RETURN_TYPE = bool;
	static constexpr const char *Name = "prefix_range_filter";
	static constexpr const char *Description =
	    "Enable prefix range filter in join filter pushdown instead of bloom filter";
	static constexpr const char *InputType = "BOOLEAN";
	static constexpr const char *DefaultValue = "false";
	static constexpr SettingScopeTarget Scope = SettingScopeTarget::LOCAL_DEFAULT;
